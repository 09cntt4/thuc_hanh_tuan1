CREATE DATABASE sales ON PRIMARY
 (
 NAME = 'thsql1-1_data',
FILENAME ='T:\NamKhoi\thsql1-1_data.mdf',
SIZE = 10MB,
MAXSIZE = 20MB,
FILEGROWTH = 20%
 )
 ...
 (
 NAME = 'thsq1-1_log',
 FILENAME = 'T:\NamKhoi\thsql1-1_log.ldf',
 SIZE = 10MB,
 MAXSIZE = 20MB,
 FILEGROWTH = 20%
 )
...
VALUES
    ('KH01', 'Nguyễn Nam Khởi', 'Tây Ninh', '090934345'),
	 ('KH02', 'Võ Nguyễn Đức Toàn', 'Tân Bình', '0946234123'),
	  ('KH03', 'Võ hoàng Minh', 'Châu Đốc', '0121682212'),
	   ('KH04', 'Châu Đăng Khoa', 'tp.HCM', '09163543'),
	    ('KH05', 'Lý công hoàng anh', 'Tiền Giang', '0829719271'),
		 ('KH06', 'Nguyễn Minh Thư', 'Tây NInh', '0126542671');
Insert into hoadon
